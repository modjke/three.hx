...
import js.html.*;
import js.three.*;
import js.three.AnimationActionLoopStyles;
...
extern class Three
{
	...
	static var ShaderChunk : ShaderChunk_;
...
@:publicFields
@:native("Object")
extern class ShaderChunk_ implements Dynamic<String>
{
